-- ============================================================
-- HOTEL WALL STREET
-- MIGRACIÓN SEGURA: CREACIÓN DE LAS 12 TABLAS FALTANTES
-- No elimina la base de datos ni las tablas existentes.
-- Basada en database/mysql/schema.sql
-- ============================================================
...
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS reservacion_visitantes (
...
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS reservacion_servicios (
    ...
    CONSTRAINT uq_reservacion_servicio
        UNIQUE (id_reservacion, id_servicio),
...
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS pases_cliente (
